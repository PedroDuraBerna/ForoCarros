...
<div class="container">
    ...
    <table class="user_table">
        ...
        <tr>
            <td>
                <p class="infoUser"><b>Ver todos mis posts: </b></p>
            </td>
            <td>
                <p class="infoUser"><a href="<?php echo base_url . "index.php?controllers=post&action=viewpost&name=" . $_SESSION["user_information"]["users_name"]  ?>"><?php echo base_url . "index.php?controllers=post&action=viewpost&name=" . $_SESSION["user_information"]["users_name"] ?></a></p>
            </td>
        </tr>
    </table>
    <h2>Conóceme</h2>
